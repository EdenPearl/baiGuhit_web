...
const Leaderboard = () => {
    ...
    const fetchLeaderboard = async () => {
        ...
        setError(null);
        try {
            const response = await fetch("https://ebaybaymo-server.onrender.com/multiple/top10");
                ...
                <TopSection>
                    <LeftPanel>
                        <Header>
                            ...
                            <Subtitle>Multiple Choice Challenge</Subtitle>
                            <BadgeRow>
                        ...
                        <ActionBar>
                            <ActionButton $secondary onClick={() => navigate("/difficulty-multiple")}>
                                <BtnIcon>🎮</BtnIcon>
                                Play Game
                            </ActionButton>
                        ...
                        <TableContainer>
                            {loading ? (
                                ...
                                <EmptyState>
                                    ...
                                    <PlayNowButton onClick={() => navigate("/difficulty-multiple")}>
                                        Play Now
                                    </PlayNowButton>
                                </EmptyState>
                            ) : (
