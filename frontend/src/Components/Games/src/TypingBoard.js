...
const TypingLeaderboard = () => {
    ...
    const fetchLeaderboard = async () => {
        ...
        setError(null);
        try {
            const response = await fetch("/typing/top10");
                ...
                <TopSection>
                    <LeftPanel>
                        <Header>
                            ...
                            <Subtitle>Typing Challenge</Subtitle>
                            <BadgeRow>
                        ...
                        <ActionBar>
                            <ActionButton $secondary onClick={() => navigate("/difficulty-typing")}>
                                <BtnIcon>⌨️</BtnIcon>
                                Play Game
                            </ActionButton>
                        ...
                        <TableContainer>
                            {loading ? (
                                ...
                                <EmptyState>
                                    ...
                                    <PlayNowButton onClick={() => navigate("/difficulty-typing")}>
                                        Play Now
                                    </PlayNowButton>
                                </EmptyState>
                            ) : (
